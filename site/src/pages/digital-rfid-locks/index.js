...
const IndexPage = () => {
  ...
  return (
      <Layout>
        <Seo
            title={t('Digital RFID Locks | Cabinet Locks | Locker Locks | Furniture Locks | Digilock')}
        ...
        <div className="legacy-landing about">
          <section className="hero">
            <div className="container">
              <p>Digital Radio frequency identification (RFID) locks by Digilock function by presenting a valid RFID Card. RFID interface is available on both NextLock and Numeris by Digilock and is available as a motorized or cam locking mechanism while operating with multiple RFID standards at 13.56 MHz.</p>
