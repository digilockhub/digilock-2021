...
const IndexPage = () => {
  ...
  return (
      <Layout>
        <Seo
            title={t('Digital Motorized Locks | Cabinet Locks | Locker Locks | Furniture Locks | Digilock')}
        ...
        <div className="legacy-landing about">
          <section className="hero">
            <div className="container">
              <p>Digital Motorized Lock solutions by Digilock feature a &#xBD;&#x201D; deadbolt or &#xBD;&#x201D; deadlatch providing a secure solution with an elevated experience. Keypad or RFID interfaces are connected to the motorized rear using a snap lock cable connector that tucks neatly into an integrated cable pocket. The mounting design accommodates a door thickness of up to 2&#x22; (50.8mm).</p>
