        ...
        <div className="legacy-landing about">
          <section className="hero">
            <div className="container">
              <p>Digilock is the original, Electronic  Lock solution designed to offer the greatest convenience to your members and easy management for your staff. Our 5th generation lock solutions are adaptive and can be set to maximize locker room capacity or to create rental revenue.</p>
