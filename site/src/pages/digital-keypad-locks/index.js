...
const IndexPage = () => {
  ...
  return (
      <Layout>
        <Seo
            title={t('Digital Locks | Cabinet Locks | Locker Locks | Furniture Locks | Digilock')}
        ...
        <div className="legacy-landing about">
          <section className="hero">
            <div className="container">
              <p>Digilock is the original, Digital Lock solution designed to offer the greatest convenience to your members and easy management for your staff. Our 5th generation lock solutions are adaptive and can be set to maximize locker room capacity or to create rental revenue.</p>
            ...
            <div className="container">
              ...
              <div className="row">
                <div className="content-row">
                  <Link
                      to={'/products/electronic-locks/#gotAspire'}
                      role={'button'}>
                    <div className="content-block aspire">
                      <div className="product">
                        ...
                        <p>Discover More</p>
                        <div className="label">
                          <img className={'logo'} src={aspireLogo} alt="Aspire"/>
                        </div>
                      </div>
                    </div>
                  </Link>
                  <Link
                    ...
                    <div className="content-block versa">
                      <div className="product">
                        ...
                        <p>Discover More</p>
                        <div className="label">
                          <img className={'logo'} src={versaLogo} alt="Versa"/>
                        </div>
                      </div>
                    </div>
                  </Link>
                  <Link
                    ...
                    <div className="content-block versa">
                      <div className="product">
                        ...
                        <p>Discover More</p>
                        <div className="label">
                          <img className={'logo'} src={versaMiniLogo} alt="Versa"/>
                        </div>
                      </div>
                    </div>
                  </Link>
            ...
            <div className="container">
              ...
              <div className="row">
                ...
                <div className="content-row adword-fix">
                  ...
                  {/*<Link*/}
                  {/*    to={'/products/electronic-locks/classic/'}*/}
                  {/*    role={'button'}>*/}
