...
const KeypadKeyManagedRfid = (props) => (
  ...
  <Accordion clsName={props.clsName}>
    ...
    <div label="Why do my locks have a green LED light?">
      <p>
        Locks with a green LED light have permanent usage functionality. This means an RFID credential needs to be
        assigned to the lock. Only the assigned credential will operate the lock.
      </p>
    </div>
    ...
    <div label="The locks at my facility have a red LED light and appear to be shared use. Assigned use is what we need, how do we fix this?">
      <p>
        Many NextLock products offer dual functionality, and can be changed in the field with the use of a Reset/Functionality Key. Please contact <a href="/contact/">Digilock support</a> so that our representatives can further assist you.
      </p>
      <p>
    ...
    <div label="I need to open a locker, and the lock beeps and flashes when I insert my Programming Key.">
      <p>
        You must press the <DigiSymbol ds={'buttonKey'} /> button first, and then insert the Programming Key.
      </p>
      <p>
