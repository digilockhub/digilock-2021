...
import DigiSymbol from '../DigiSymbols/DigiSymbol'

const AspireVersaFaq = (props) => (
  ...
  <Accordion clsName={props.clsName}>
    <div label="What is factory default?">
      ...
      <p>
        ...
        onClick={() => jumpAccordion(props.product + ' Keypad Getting Started',
    ...
    <div label="The LED flashes twice and the keypad is nonresponsive.">
      <p>
        When the incorrect user code or RFID credential is used three consecutive times, the lock goes into sleep mode for 60 seconds. The lock will go into sleep mode for each subsequent failed attempt. A valid Manager Key may be used to unlock while the lock is in sleep mode
      </p>
    </div>
    ...
    <div label="Why do my locks have a red LED light?">
      <p>
        Locks with a red LED light have shared usage functionality. This means when unlocked, the lock will accept any 4-7 digit user code.
      </p>
    </div>
    <div label="Why do my locks have a green LED light?">
      <p>Locks with a green LED light have assigned usage functionality. This means a 4-7 digit user code needs to be assigned to the lock. Only the assigned code will operate the lock.</p>
    ...
    <div label="The locks at my facility have a red LED light and appear to be shared use. Assigned use is what we need, how do we fix this?">
      <p>
        Numeris products offer dual functionality and can be changed in the field. Please follow the section to <span
        onClick={() => jumpAccordion(props.product + ' Keypad Getting Started',
          'Set Lock Functionality')}>Set Lock Functionality</span>.
      </p>
      <p>
